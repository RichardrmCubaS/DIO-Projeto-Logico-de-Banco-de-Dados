...
-- Busca data de nascimento e endereço
select Bdate, Address from employee
	where Fname = 'John' and Minit = 'B' and Lname = 'Smith';
    
-- Busca departamento especifico (Research)
...
-- Select em 3 tabelas diferentes atributos especificos
